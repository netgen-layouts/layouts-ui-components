...
export default css`
  ...
  .edit-menu {
    ...
    bottom: 100%;
    gap: 0.25rem;
    z-index: calc(var(--ngl-block-base-z-index, 80000) + 12);
  }
  ...
  main.is_selected .action-btns button {
  ...
  .dropdown-menu {
    ...
    box-shadow: 0px 4px 8px 0px rgba(34, 9, 67, 0.25);
    z-index: calc(var(--ngl-block-base-z-index, 80000) + 12);
  }
